...
const ForgotPassword = () => {
    ...
    const handleSendOtp = async (e) => {
        ...
        // Prevent sending if cooling down (unless it's the first step where we might not want to block or logic differs)
        // But typically resend logic is only available in Step 2.
        // For Step 1, we just send.
        // For Resend button in Step 2:
                ...
                {step === 2 && (
                    <form onSubmit={handleVerifyOtp} className="auth-form">
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '10px' }}>
                            ...
                            >
                                {countdown > 0 ? `(${countdown}s) 重寄` : '沒收到？重寄'}
                            </button>
                        </div>
                    </form>
                )}
