...
function App() {
    ...
    const handleLogin = (newToken, newEmail, newUsername) => {
                ...
                <Route
                    ...
                    element={
                        <ProtectedRoute token={token}>
                            <ChatPage token={token} username={username} onLogout={handleLogout} isDarkMode={isDarkMode} toggleTheme={toggleTheme} />
                        </ProtectedRoute>
                    }
                />
